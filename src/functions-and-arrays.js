...
function averageNumbers(arrayNumbers) {
  ...
  return value / arrayNumbers.length;
}
...
function howManyTimes(firstWord, secondWord) {
  ...
  let numberOfWords = 0;
firstWord.forEach(_number => {
  if(_number === secondWord){
    numberOfWords++
  }
});
